...
## converts all factors into characters. converts Date into Date class
##  All others except Time to numeric
...
##create plot and store as png file 
	with(mydata,hist(Global_active_power,xlab="Global Active Power (kilowatts)",col = "orangered1",main = "Global Active Power"))
